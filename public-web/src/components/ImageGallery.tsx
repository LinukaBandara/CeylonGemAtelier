...
export function ImageGallery({
  ...
  if (!images || images.length === 0) {
    return (
      <div className="w-full aspect-square bg-gradient-to-br from-[#F0EBE3] to-[#E5DFD5] flex items-center justify-center">
        <p className="text-[var(--color-muted)]">Gallery Coming Soon</p>
      </div>
    );
  }
            ...
            <button
              ...
              className={`flex-shrink-0 w-16 h-16 border-2 transition-all ${
                selectedIndex === index
                  ...
                  : "border-[var(--color-stone)]/40 hover:border-[var(--color-graphite)]/50"
              }`}
            >
